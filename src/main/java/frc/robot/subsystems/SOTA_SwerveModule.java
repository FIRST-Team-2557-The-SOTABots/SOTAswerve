...
public class SOTA_SwerveModule {
    ...
    public void setModule(SwerveModuleState swerveModuleState) {
        ...
        double anglePIDOutput = anglePID.calculate(getCurrentAngle().getRotations(), swerveModuleState.angle.getRotations());

        double speedRPM = Conversions.metersPerSecondToRPM(swerveModuleState.speedMetersPerSecond, kWheelCircumfrence, kGearRatio);
